...
spack install netcdf-fortran@4.6.1 % intel arch=linux-rhel8-cascadelake
...
spack install vmd % intel arch=linux-rhel8-cascadelake
spack install r@4.3.0 % gcc@13.2.0 arch=linux-rhel8-cascadelake
spack install lammps % intel ^intel-oneapi-mkl +cluster mpi_family=mpich arch=linux-rhel8-cascadelake
